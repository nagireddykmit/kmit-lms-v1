...
<!-- #nav-menu-container -->
	...
	.container{
		padding:40px 20px;
                   ...
                   <div class="container">
				   <h2 style="font-family:Georgia;color:#000000;" align="center">Approved Leave History</h2>
                                        ...
                                        <tr>
                                           <td class="th-sm" style="font:small-caps 15px/30px Georgia, serif;"> <b><?php echo htmlentities($cnt);?></b></td>
											<td class="th-sm" style="font:small-caps 15px/30px Georgia, serif;"><?php echo htmlentities($result->EmpId);?></td>
                                              <td class="th-sm" style="font:small-caps 15px/30px Georgia, serif;"><?php echo htmlentities($result->FirstName." ".$result->LastName);?></td>
											...
											<td>
													<?php if($result->Description=="no")
																...
																echo "<a href='somepage.php?leaveid=".$result->lid."' class='waves-effect waves-light btn blue m-b-xs'>YES</a>"; ?>
											</td>
                                                                       <td class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;"><?php $stats=$result->Status;
											if($stats==1){
                                             ?>
