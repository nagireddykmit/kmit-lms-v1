...
<!-- #nav-menu-container -->
    ...
    <div class="card card-container">
            <h3 style="font-family:Georgia ;font-size:25px;color:#2F4F4F;" align="center">UPDATE EMPLOYEE INFORMATION </h3>
		...
		<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
		   ...
		   <div style="width:48%;float:left;"> 
				...
				<span>EmailId<input class="form-control"  name="email" type="email" id="email" value="<?php echo htmlentities($result->EmailId);?>" autocomplete="off" readonly required></span>
		   ...
		   <div style="width:48%;float:right;"> 
						<span>Date of Birth<input type="date" class="form-control" id="birthdate" name="dob"  class="datepicker" value="<?php echo htmlentities($result->Dob);?>"></span>
                      <span>Date of Joining<input type="date" class="form-control" id="doj" name="doj" class="datepicker" value="<?php echo htmlentities($result->doj);?>"></span>
					...
					<span>Aadhaar Number<input class="form-control" id="adharno" name="adharno" type="text"  value="<?php echo htmlentities($result->adharno);?>" autocomplete="off" required></span>
                    <span>Pan Card Number<input class="form-control"  id="pancardno" name="pancardno" type="text"  value="<?php echo htmlentities($result->pancardno);?>" autocomplete="off" required></span>
					<span>JNTU UID<input class="form-control"  id="jntu_uid" name="jntu_uid" type="text"  value="<?php echo htmlentities($result->jntu_uid);?>" autocomplete="off" required></span>
					<span>AICTE ID<input class="form-control"  id="aicteid" name="aicteid" type="text"  value="<?php echo htmlentities($result->aicteid);?>" autocomplete="off" required></span>
		              </div>
                </div>
