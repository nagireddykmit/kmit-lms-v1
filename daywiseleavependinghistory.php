...
<html lang="en">
  ...
  location.replace('daywisependingvar.php?month='+month);
}
</script>
    </head>
...
<!-- #nav-menu-container -->
	...
	<h2 style="font-family:Georgia;color:#000000;" align="center">Employees Daywise Approved/Pending Leaves History</h2>
		...
		<table align="center" id="example" class="table table-striped table-responsive table-bordered" border="1" cellspacing="0" style="table-layout: auto;width: 100%;">
			<thead>
				<tr>
					...
					<th class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;">DATE RANGE</th>
			...
			{               ?>  
						<tr>
							...
							<td style="font: small-caps 15px/30px Georgia, serif;"><?php echo "From ".$result->tf." to ".$result->tt;?></td>
							<td style="font: small-caps 15px/30px Georgia, serif;"><?php echo $statusArr[$result->ts];?></td>
						</tr>
						 <?php $cnt=$cnt+1;} }?>
					</tbody>
				</table>
