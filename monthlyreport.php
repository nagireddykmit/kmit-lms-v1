			...
			if($remain>0)
				...
				$monthresult[$cn] = array( 
					...
					"Department" => "".$row['Department'] ,
				        "Available CLs" => "".$row['icl'],	
					"Used CLs" => "".($row['icl']-$row['cl']) , 
					"Available CCLs" => "".($row['iccl']),
					"Used CCLs" =>"".($row['iccl']-$row['ccl']) , 
					"OD" => "".$row['od'] , 
					"AL" => "".$row['al'] , 
					"Total" => "".$tot , 
					"Availed" => "".$row['avail'] , 
...
<div class="container">
			...
			<li id="export-to-csv"><a href="#">Export to csv</a></li>
			   ...
			   <table class="table table-striped table-responsive table-bordered" id="" cellspacing="0" border="2" style="table-layout: auto;width: 100%;" >
					<tr>
						...
						<th class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;">Available CLs</th>
						<th class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;">Used CLs</th>
						<th class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;">Available CCLs</th>
						<th class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;">Used CCLs</th>
	...
	<?php 
						...
						<td style="font-family:Lucida Fax;"><?php echo $row['Available CLs']; ?></td>
						<td style="font-family:Lucida Fax;"><?php echo $row['Used CLs'];?></td>
						<td style="font-family:Lucida Fax;"><?php echo $row['Available CCLs'];?></td> 
						<!--ccl-->
						<td style="font-family:Lucida Fax;"><?php echo $row['Used CCLs']; ?></td>
						<!--od-->
