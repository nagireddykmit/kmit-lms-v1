 ...
 $output .= '
   <table class="table table-striped table-responsive table-bordered" id="Employees" cellspacing="0" style="table-layout: auto;width: 100%;" >
	...
	<th class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;">EmpID</th>
     ...
     <th class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;">City</th>
     <th class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;">Country</th>
    </tr>
	</thead>
	<tbody>
 ';
 while($row = mysqli_fetch_array($result))
 {
  $output .= '
   <tr class="item">
    ...
    <td style="font: small-caps 15px/30px Georgia, serif;">'.($row["City"]).'</td>
    <td style="font: small-caps 15px/30px Georgia, serif;">'.($row["Country"]).'</td>
   </tr>
  ';
 }
 $output .="</tbody>";
