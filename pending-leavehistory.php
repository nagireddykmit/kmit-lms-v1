...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>HOD | Employee Pending leaves </title>
...
<pre><a href="action.php?leaveid=<?php echo htmlentities($result->lid);?>&status=1" class="waves-effect waves-light btn blue m-b-xs" id="approve<?php echo $cnt; ?>" >Approve</a><br><br><a href="action.php?leaveid=<?php echo htmlentities($result->lid)?>&status=2" class="waves-effect waves-light btn blue m-b-xs" id="reject<?php echo $cnt; ?>">Reject</a></pre>
