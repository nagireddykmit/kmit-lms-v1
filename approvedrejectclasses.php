...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Employee | Adjustments History</title>
...
<!-- #nav-menu-container -->
     ...
     <div class="container">
<h2 style="font-family:Georgia;color:#000000;" align="center">
<!--<?php echo strtoupper($_SESSION['emname']);?>'s ADJUSTMENTS HISTORY-->
ALL ADJUSTMENTS HISTORY
			...
			<thead>
                                        <tr>
											...
											<th class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;">Leave ID</th>
                                            <th class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;">Adjusted From</th>
											<th class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;">Adjusted To</th>
...
$status=0;
$epid=$_SESSION['empid'];
$sql = "SELECT leaveid, empid, empname,adjustedfrom,department,Year,Section,Subject,Timings,classdate,actionstatus from classadjustments where empid=:epid or adjempid=:epid order by leaveid desc";
	  ...
	  <div id="defaultDialog">
			<div id="Grid"></div>
                                        ...
                                        <tr>
											...
											<td class="th-sm" style="font:small-caps 15px/30px Georgia, serif;"><?php echo htmlentities($result->leaveid);?></td>
                                            <td class="th-sm" style="font:small-caps 15px/30px Georgia, serif;"><?php echo htmlentities($result->adjustedfrom); ?></a></td>
											<td class="th-sm" style="font:small-caps 15px/30px Georgia, serif;"><?php echo htmlentities($result->empname); ?></a></td>
